        ...
        <nav className="bg-sky-600">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <Link to="/" className="text-white  hover:text-white block px-3 py-2 rounded-md text-base font-medium">Home</Link>
                    <Link to="/products" className="text-gray-300  hover:text-white block px-3 py-2 rounded-md text-base font-medium">Products</Link>
                    <Link to="/cart" className="text-gray-30 hover:text-white block px-3 py-2 rounded-md text-base font-medium">cart</Link>
